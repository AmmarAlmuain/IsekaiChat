<template>
    <div class="h-screen text-white flex p-4 max-sm:p-0 justify-center items-center relative">
        <section
            class="register-form w-full max-w-[500px] border max-sm:rounded-none max-sm:border-l-0 max-sm:border-r-0 max-sm:border-t max-sm:border-b rounded-md border-white/10 p-8 flex flex-col justify-center items-center bg-[#1c1c1c]">
            <form class="flex flex-col w-full justify-center max-w-[384px] items-center gap-y-4"
                ...
                <div class="w-full py-6">
                    <button type="submit" class="w-full h-10 bg-emerald-700 rounded-md border border-emerald-500 cursor-pointer hover:bg-emerald-600 transition-all duration-300">
                        <span :class="inProcess ? 'loading loading-ring loading-xs' : ''"> Register </span>
                    </button>
                </div>
            </form>
        </section>
